/**
 * ATS.me Embed Widget Loader
 * 
 * Usage:
 * <div id="ats-apply-widget"></div>
 * <script 
 *   src="https://ats.me/widget.js" 
 *   data-token="your-token-here"
 *   data-container="ats-apply-widget"
 *   async
 * ></script>
 * 
...
(function() {
  ...
  // Validate token
  if (!token) {
    console.error('[ATS Widget] Missing required data-token attribute');
  ...
  function init() {
    ...
    if (!container) {
      console.error('[ATS Widget] Container element not found:', containerId);
    ...
    fetch(resolveUrl)
      ...
      .catch(function(error) {
        console.error('[ATS Widget] Failed to load:', error);
