...
export function useBulkOperations() {
  ...
  const { data: operations, isLoading } = useQuery({
    queryKey: ['tenstreet-bulk-operations'],
    queryFn: async () => {
  ...
  const importMutation = useMutation({
    mutationFn: async (data: { file: File; mappings: Record<string, string>; companyId: string }) => {
      ...
      // Call TenstreetService - need to convert File to data array
      // For now, we'll pass the file name as source and empty data
      // In a real implementation, you'd parse the file first
