...
const JobGroups = React.lazy(() => import("@/features/campaigns").then(m => ({ default: m.JobGroupsPage })));
...
const TenstreetDashboard = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetDashboard })));
const TenstreetIntegration = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetIntegration })));
const TenstreetExplorer = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetExplorer })));
const TenstreetXchange = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetXchange })));
const TenstreetFocus = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetFocus })));
const TenstreetBulk = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetBulk })));
const TenstreetCredentialsManagement = React.lazy(() => import("@/features/tenstreet").then(m => ({ default: m.TenstreetCredentialsManagement })));
...
const Platforms = React.lazy(() => import("@/features/platforms").then(m => ({ default: m.PlatformsPage })));
...
const Organizations = React.lazy(() => import("@/features/admin").then(m => ({ default: m.OrganizationsPage })));
const Settings = React.lazy(() => import("@/features/settings").then(m => ({ default: m.SettingsPage })));
const Media = React.lazy(() => import("@/features/media").then(m => ({ default: m.MediaPage })));
const UserManagement = React.lazy(() => import("@/features/admin").then(m => ({ default: m.UserManagementPage })));
