 ...
 * Social share buttons for blog posts with platform-specific links and clipboard fallback
 */
        ...
        <div className="grid gap-1">
          {shareLinks.map((link) => (
            <a
              ...
              className="flex items-center gap-3 rounded-md px-3 py-2 text-sm hover:bg-muted transition-colors text-foreground"
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-md px-3 py-2 text-sm hover:bg-muted transition-colors text-foreground w-full text-left"
