  ...
  return (
    <main className="min-h-screen">
      <SEO
        ...
        description="Hire faster with AI voice technology. Jobseekers receive automated callbacks within minutes. 24/7 AI voice agents, Voice Apply technology, 100+ job board integrations. Join 50+ pilot companies."
