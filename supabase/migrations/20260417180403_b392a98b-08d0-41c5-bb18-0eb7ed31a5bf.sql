...
BEGIN
  IF NEW.phone IS NOT NULL AND NEW.phone != '' AND length(NEW.phone) >= 10 THEN
    ...
    -- (utm_source or utm_medium contains 'zip', case-insensitive).
    -- This prevents AI calls on low-quality CDL Job Cast traffic while still
    -- honoring genuine ZipRecruiter sub-source leads.
